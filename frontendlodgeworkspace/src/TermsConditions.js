...
export default function TermsConditions() {
    return(
        <div className="div-trms">
            <div className="trms-div"></div>
            <div className="trms-div2">
                <h1>Terms and Conditions</h1>
                <p>Last updated: January 17, 2021</p>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        Agreement) refers to Flathopper, LLC, 410 Bagby St, Houston, TX 77002.
                    </li>
                    <li>
                    ...
                    <li>Website refers to Flathopper, accessible from[genericwebsite.com](genericwebsite.com)</li>
                    <li>
                ...
                <ul>
                    <li>By email: flathopper@genericwebsite.com</li>
                </ul>
            </div>
            <div className="trms-div3"></div>
        </div>
    )
}